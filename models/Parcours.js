module.exports = class Parcours {
  ...
  /**
   * parcours's constructor: Initialize the parcours, fields are optional
   * @param {*} db - the database's connection 
   * @param {String[]} [data] - parcours's datas
   */
  constructor(db, data={}){
    this.#conn = db
  ...
  /**
   * Reads all parcours from the database
   * 
   * @param {apiCallback} callback - callback called after getting parcours datas
   * 
   */
  read_all(callback){
  ...
  /**
   * Reads a single parcours from the database
   * 
   * @param {apiCallback} callback -  callback called after getting parcours datas
   * 
   */
   ...
   * Creates a parcours
   * 
   * @param {apiCallback} callback - callback called after creating the parcours
   * 
   */
  create(callback){
  ...
  /**
   * Updates a parcours according to its id
   * 
   * @param {apiCallback} callback - callback called after updating the parcours
   * 
   */
  update(callback){
  ...
  /**
   * Delete a parcours according to its id
   * 
